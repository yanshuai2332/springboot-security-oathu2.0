 ...
 */
public class CustomOAuth2ExceptionJackson2Deserializer extends StdDeserializer<CustomOAuth2Exception> {

	public CustomOAuth2ExceptionJackson2Deserializer() {
		super(CustomOAuth2Exception.class);
	}

	@Override
	public CustomOAuth2Exception deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException{
		...
		return (CustomOAuth2Exception) ex;
